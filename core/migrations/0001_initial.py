    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_lista_curso', models.ForeignKey(db_column='id_lista_curso', on_delete=django.db.models.deletion.DO_NOTHING, to='core.listacursos', verbose_name='Nombre Curso')),
                ('id_matricula', models.ForeignKey(db_column='id_matricula', on_delete=django.db.models.deletion.DO_NOTHING, to='core.matricula', verbose_name='Id Matricula')),
            ],
            options={
